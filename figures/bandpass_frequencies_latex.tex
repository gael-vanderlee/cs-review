...
% Notch filter crosses (native PGF markers: legend match, no data-scale distortion)
\addplot[only marks, mark=x, red, mark size=3pt, mark options={line width=0.7pt}, forget plot] coordinates {
    (50.0, 1)
    (60.0, 4)
    (50.0, 18)
    (50.0, 19)
