...
A systematic literature search across three databases, PubMed, Web of Science, and Scopus, retrieved records published through the 27th of March 2025. No earlier date restriction was imposed, so the search captures the full historical record of the field up to that date.
...
Records identified by the search were screened in accordance with the Preferred Reporting Items for Systematic Reviews and Meta-Analyses (PRISMA) 2020 statement; the full selection process is summarized in the PRISMA flow diagram (Figure~\ref{fig:prisma}).
...
\begin{itemize}
    \item The study employed a neuroimaging modality (EEG, ERP, fNIRS, fMRI, MEG, ECoG, PET) or a brain-stimulation modality (tDCS, tACS, TMS, GVS) to measure or modulate brain activity.
    \item The study addressed VIMS or a closely related construct (simulator sickness, or motion sickness in a virtual environment) within a virtual reality or otherwise immersive context.
    \item The study reported original empirical results from human participants, including reanalyses of previously released public datasets.
\end{itemize}
...
\begin{itemize}
    ...
    \item The study did not address VIMS or a related sickness construct as a primary outcome.
...
The remaining 92 articles comprise the final corpus analyzed in this review.
PET returned no eligible studies; MEG returned a single record, which was excluded at the title-and-abstract stage as not addressing VIMS or a related sickness construct; fMRI returned no records at all.
...
\begin{enumerate}
    ...
    \item \textbf{Sickness Measurement:} The methods used to measure or label VIMS, distinguishing between subjective questionnaires (e.g., SSQ, FMS, VRSQ) and objective physiological or behavioral metrics (e.g., galvanic skin response, postural sway).
    ...
    \item \textbf{Theoretical Framework:} The explicitly stated or implicitly assumed theory of VIMS (e.g., sensory conflict, postural instability) that guided the study's design or interpretation.
