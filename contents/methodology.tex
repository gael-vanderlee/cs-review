...
The remaining 92 articles comprise the final corpus analysed in this review.
...
\begin{enumerate}
    ...
    \item \textbf{Sickness Measurement:} The methods used to measure or label VIMS, distinguishing between subjective questionnaires (e.g., SSQ, FMS, VRSQ) and objective physiological or behavioural metrics (e.g., galvanic skin response, postural sway).
