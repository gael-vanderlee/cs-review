...
\begin{figure*}[hbt!]
    ...
    \caption{PRISMA flow diagram for the present review. \TODO[prisma:figure]{Figure to be regenerated to match the updated counts in the text (443 identified; 219 after duplicate removal; 119 excluded at title/abstract; 8 reports not retrieved; 92 included).}}
    \label{fig:prisma}
\end{figure*}
