...
Second, we report meta-analytic evidence that VR display hardware systematically modulates the neural responses associated with cybersickness, recasting prior contradictions in the literature as partly attributable to hardware confounds rather than to differences in cybersickness per se.
