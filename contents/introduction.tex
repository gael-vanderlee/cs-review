...
The relationship between cybersickness, VIMS, simulator sickness, and motion sickness is treated in detail in Section~\ref{sec:theoretical}; the present review follows the umbrella terminology when introducing constructs and uses the term each cited study employs when reporting its findings.
...
The first records neural activity --- primarily electroencephalography (EEG), and to a lesser extent functional near-infrared spectroscopy (fNIRS) and functional magnetic resonance imaging (fMRI) --- to identify signals that index the onset, severity, or trajectory of cybersickness.
...
Third, we conduct a methodological audit of the field, including detection of publication bias (Egger's test, $p=0.011$) and examination of reporting practices in classification studies, and derive concrete recommendations for future VR-EEG and VR-stimulation work.
