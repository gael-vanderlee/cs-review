...
Our meta-analysis supports these concerns, revealing statistically significant differences in neural response patterns between different hardware platforms and virtual environment types (see \autoref{sec:confounders}).
